...
public class IndividualSWRLBuiltinTutorial {
    ...
    private static final String DOC_URL = "http://www.semanticweb.org/lucas/ontologies/2019/7/AAL";
    ...
    public static void main(String[] args) throws OWLOntologyCreationException {
        ...
        OWLNamedIndividual P1 = factory.getOWLNamedIndividual(":SFB1", pm);
        System.out.println("ASSERTATIONS:");
        listAllDataPropertyValues(P1, ontology, reasoner);
    }
